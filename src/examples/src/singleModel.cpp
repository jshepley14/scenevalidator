/****************************************************
  ...
  Description:  This program loads a single object four different times. You can use this program to see if
...
// Here's all the input^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  scene->setScale(0, 100);                       //set modelnames[0] to be scaled down by factor of 100   
